...
We fit the standard Latin-square model $y_{ijk} = \mu + \alpha_i + 
\beta_j + \gamma_k + \epsilon_{ijk}$ where:

- $\alpha_i$ = treatment effect
- $\beta_j$ = row (batch) effect
...
What does the $P( \gt F )$ value for trt tell us? Does the treatment means differ significantly?
